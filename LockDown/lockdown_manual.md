...
Dificultad: Facil
Categoria: Analisis Forense en de redes y Endpoints (Network & Memory Forense)
Herramientas Utilizadas: Wireshark, Volatility 3, Virus Total

Resumen:
Investigacion de una intruccion cibernetica de multiples etapas contra un servidor web IIS publico de TecNova Systems. El ataque abarco desde el reconocimiento inicial con Nmap hasta la enumeracion de recursos compartidos mediante de SMB, el despliegue de un archivo malicioso, la ejecucion de una reverse shell hacia la infraestructura del atacante y la persistencia de un troyano de acceso remoto (RAT)

Analisis paso a paso y resolucion

Fase 1: Analisis de Red (pcap):
